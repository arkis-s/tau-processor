...
add wave -noupdate -label {ZERO FLAG} {/testbench_alu/flags[7]}
add wave -noupdate -label {SIGN FLAG} {/testbench_alu/flags[6]}
add wave -noupdate -label {CARRY FLAG} {/testbench_alu/flags[5]}
add wave -noupdate -label {OVERFLOW FLAG} {/testbench_alu/flags[4]}
...
WaveRestoreCursors {{Cursor 2} {10 ps} 0}
