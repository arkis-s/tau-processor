...
add wave -noupdate -label count_up /testbench_counter_loadable/count_up
add wave -noupdate -label count_down /testbench_counter_loadable/count_down
add wave -noupdate -label load /testbench_counter_loadable/load
add wave -noupdate -label reset /testbench_counter_loadable/rst
